...
module drawing() {
    ...
    // MOVED TO THE DOCUMENT: cap("A low louver (4) gives the exhaust fan's warm air a direct path OUT toward the tailgate — the rest stays dust/draft control.", 13, -21.5, 1.4);
