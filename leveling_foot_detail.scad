...
module drawing() {
    ...
    side_list(30, 42, [
        ["1", "Leg (bottom end shown)", str("2x2 pine (1.5\" x 1.5\" actual), cut to ", leg_cut_length, "\""), "drill centered, 1/2\" dia x 3/4\" deep for the insert"],
        ["2", str(leveling_foot_thread, " threaded insert"), "driven UP into the leg's end grain", "T-nut style, epoxy or press-fit"],
