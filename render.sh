...
echo "Rendering isometric view (platform only)..."
openscad -o renders/isometric.svg -D "show_van_shell=false" iso_view.scad
openscad -o renders/isometric.png $IMG $FLAT_CAM -D "show_van_shell=false" iso_view.scad

echo "Rendering isometric fit-check (with van envelope)..."
openscad -o renders/fit-check-isometric.svg -D "show_van_shell=true" iso_view.scad
openscad -o renders/fit-check-isometric.png $IMG $FLAT_CAM -D "show_van_shell=true" iso_view.scad
...
openscad -o renders/delta3-wave3-detail.png --imgsize=1400,2600 $FLAT_CAM delta3_wave3_detail.scad

echo "Rendering headboard storage detail..."
openscad -o renders/headboard-storage-detail.svg headboard_storage_detail.scad
openscad -o renders/headboard-storage-detail.png --imgsize=1800,1400 $FLAT_CAM headboard_storage_detail.scad
...
for p in A B C; do
    ...
    openscad -o renders/panel-$lp-detail.png --imgsize=1800,1400 $FLAT_CAM -D "panel=\"$p\"" panel_detail.scad
done

echo "Rendering headboard elevations (all 4 sides)..."
openscad -o renders/headboard-elevations.svg headboard_elevations.scad
openscad -o renders/headboard-elevations.png --imgsize=1900,1400 $FLAT_CAM headboard_elevations.scad

echo "Rendering cabinet door detail..."
openscad -o renders/cabinet-door-detail.svg cabinet_door_detail.scad
openscad -o renders/cabinet-door-detail.png --imgsize=1800,1200 $FLAT_CAM cabinet_door_detail.scad

echo "Rendering leveling foot detail..."
openscad -o renders/leveling-foot-detail.svg leveling_foot_detail.scad
openscad -o renders/leveling-foot-detail.png --imgsize=1800,1200 --camera=0,0,0,0,0,0,60 --projection=o --autocenter --viewall leveling_foot_detail.scad

echo "Rendering bed frame detail..."
openscad -o renders/bed-frame-detail.svg bed_frame_detail.scad
openscad -o renders/bed-frame-detail.png --imgsize=1800,1200 $FLAT_CAM bed_frame_detail.scad

echo "Rendering sway brace detail..."
openscad -o renders/sway-brace-detail.svg sway_brace_detail.scad
openscad -o renders/sway-brace-detail.png --imgsize=1800,1200 $FLAT_CAM sway_brace_detail.scad

echo "Rendering kitchen drawer detail..."
openscad -o renders/kitchen-drawer-detail.svg kitchen_drawer_detail.scad
openscad -o renders/kitchen-drawer-detail.png --imgsize=1800,1000 $FLAT_CAM kitchen_drawer_detail.scad

echo "Rendering Panel C front wall detail..."
openscad -o renders/panel-c-wall-detail.svg panel_c_wall_detail.scad
openscad -o renders/panel-c-wall-detail.png --imgsize=1800,1000 $FLAT_CAM panel_c_wall_detail.scad

echo "Rendering electrical layout detail..."
openscad -o renders/electrical-layout.svg electrical_layout_detail.scad
openscad -o renders/electrical-layout.png --imgsize=1500,2700 $FLAT_CAM electrical_layout_detail.scad
