...
- **Panel B**: **no drawers, no divider** — the side-door openings don't reach it. Its whole bay is deep storage: lift the platform + mattress off and load from above. **Containerized (owner, July 2026): 4× Sterilite 28-Qt under-bed lidded totes** (23.5" × 16.9" × 5.9"), 2 wide × 2 high on the van floor in the bay — you lift out whole labeled totes instead of rummaging a loose pile (plain lidded totes on purpose: with no side access, a slide-drawer front would be a wasted feature). A third tote layer still clears the platform if you need it. Use it for the long-term/bulky stuff you don't touch at camp.
...
| Panel B deep-storage totes | 4x Sterilite 28-Qt under-bed lidded totes (23.5" x 16.9" x 5.9"), 2 wide x 2 high on the van floor in Panel B's bay — containerized top-load storage (lift the platform, lift out whole totes) |
...
| Panel B totes — Sterilite 28-Qt under-bed lidded (23.5" x 16.9" x 5.9"), 2 wide x 2 high in the bay | 4 | $12 | $48 |
...
- **Panel B deep-storage totes**: [Sterilite 28-Qt under-bed lidded tote](https://www.amazon.com/Sterilite-16558010-28QT-Storage-Box/dp/B0042KXV28) ×4 — plain lidded totes on purpose (Panel B has no side access, so slide-drawer versions would waste money).
...
Same frame construction as Panel A — and that's the whole build. **Panel B has no drawers, no divider, and no skirts**: the sliding-door openings sit over Panel A's footprint, not Panel B's (owner-confirmed), so nothing pulled sideways from this panel could ever clear a door. Its bay is deep storage instead — lift the platform + mattress and load it from above with the long-term/bulky things you don't touch at camp, **containerized in 4× Sterilite 28-Qt under-bed lidded totes** (23.5" × 16.9" × 5.9", 2 wide × 2 high on the van floor) so whole labeled boxes lift out instead of loose items. The Panel B detail render dimensions **every hole in the panel**: the 4 leg-bottom leveling-insert holes (1/2" dia x 3/4" deep, dead center of each leg's end grain) and the alignment-pin holes on both seam faces (2x 3/8" dia x 3/8" deep, 3" in from each side edge).
...
- Deep-storage totes — 4x Sterilite 28-Qt under-bed lidded (23.5" x 16.9" x 5.9"), 2 wide x 2 high in the bay (plain lidded, NOT slide-drawer — no side access to use a drawer front)
...
**Total: ~$3,090–3,485 with the fridge + kitchen, or ~$2,390–2,635 if you already own equivalents** (see Section 4 for the full itemized BOM and every purchase link).
