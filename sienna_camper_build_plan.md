...
| Spare tire stowage | RJ-MODINI kit (T155/85R18 on an 18x4 steel wheel, 28.5" dia x ~6.4" stored, ~40 lb w/ 2-ton jack) FLAT in Panel B's bay at the axle: 3x ~3" cleats (offcut) + 1 cam strap to the bottom rails + tool case nested in the wheel — see the Spare Tire Stowage render |
...
- SPARE TIRE — RJ-MODINI kit for the 2011-2026 Sienna incl. Hybrid (T155/85R18 steel wheel, 28.5" dia x ~6.4" stored, ~40 lb incl. 2-ton jack/wrenches/cases — VERIFY weight + dims on arrival). Stows FLAT in this bay at the AXLE: 3x ~3" wood cleats (from the 3/4" offcut) lift it above the bottom-rail curb, one cam strap over the stack anchors to the bottom rails, the tool case nests inside the wheel barrel
- NOTE: the spare does NOT fit above the kitchen (28.5" disc vs ~24" before the fridge blocks it) — Panel B is the only interior spot, and it's the best one: 35 lb at the axle beats any hitch basket (which would lever ~130+ lb onto the rear axle)
...
2. Connect power + stow the DELTA 3 stack and WAVE 3; load Panel B — RJ-MODINI spare flat on its cleats + strap, tool case in the wheel, 2 totes on top.
...
**Frame / fasteners** — rear pantry: 2× IRIS 3-packs, Home Depot #500163 ($61) + cam strap/D-rings/felt/Velcro hold-down ($26) + pot crate ($15) + 2× Sterilite 28-Qt Panel B totes ($24) + the RJ-MODINI spare kit ($350 — stows in Panel B at the axle); corner brackets ×12 ($12); diagonal corner braces ×8 ($24); seam draw-latches ×4 ($16); wood screws ($20); wood glue ($8); [Ryobi R-series biscuit assortment](https://www.amazon.com/) ($12); alignment dowel pins ($3); anti-rattle bumper strip ($10).
...
**Total: ~$3,350–3,740 with the fridge + kitchen, or ~$2,650–2,890 if you already own equivalents** (see Section 4 for the full itemized BOM and every purchase link).
