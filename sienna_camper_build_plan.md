...
| Spare tire stowage | Modern Spare kit (T145/85R18, 27.7" x 5.7", ~30-35 lb w/ jack) FLAT in Panel B's bay at the axle: 3x ~3" cleats (offcut) + 1 cam strap to the bottom rails + jack case beside it — see the Spare Tire Stowage render |
...
| Modern Spare complete kit — 2021-2026 Sienna (T145/85R18 + jack + wrench + case) — **UNVERIFIED price, check the listing** | 1 | $300-390 | $300-390 |
...
| Cable grommets (1 cooktop line, 1 Power strip 1's line — both short hops to the rear outlet now, 3 fridge DC line, 2 DELTA 3 AC charging line) | 7 | $6 | $42 |
...
- **Spare tire**: [Modern Spare complete kit, 2021-2026 Sienna](https://modernspare.com/product/2021-2026-toyota-sienna-spare-tire-kit-options/) (also on [Amazon](https://www.amazon.com/Complete-Compact-Spare-Tire-Carrying/dp/B09LRFJRYV)) — T145/85R18 on an alloy wheel, diameter-matched to the AWD drivetrain; the COMPLETE kit includes the jack, wrench, and case. Cleats and strap come from stock already on hand.
...
Power strip 1 (phone/device charging, reading light, the Claymore fan) mounts at the **rear pantry's deck edge** in the open bay (Component 1) — which sits directly beside the rear outlet. One short 120V AC cord:
...
- SPARE TIRE — Modern Spare complete kit for the 2021-2026 Sienna (T145/85R18, 27.7" dia x 5.7", ~30-35 lb incl. jack/wrench/case — VERIFY weight + price on the listing). Stows FLAT in this bay at the AXLE: 3x ~3" wood cleats (from the 3/4" offcut) lift it above the bottom-rail curb, one cam strap over the stack anchors to the bottom rails, jack case strapped beside it
- NOTE: the spare does NOT fit above the kitchen (27.7" disc vs ~24" before the fridge blocks it) — Panel B is the only interior spot, and it's the best one: 35 lb at the axle beats any hitch basket (which would lever ~130+ lb onto the rear axle)
...
**Total: ~$3,300–3,780 with the fridge + kitchen, or ~$2,600–2,930 if you already own equivalents** (see Section 4 for the full itemized BOM and every purchase link).
