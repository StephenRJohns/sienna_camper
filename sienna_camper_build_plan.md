...
| Spare hold-down hardware: 2x 1" footman loops (from a 4-pack, screws included) + 1" x 12 ft cam-buckle strap (from a 6-pack — spares cover the pantry + DELTA 3 drawer straps); skid + liner from offcuts | 1 set | $24 | $24 |
...
- **Spare hold-down hardware**: [NVAAV 1" stainless footman loops, 4-pack w/ screws](https://www.amazon.com/NVAAV-Stainless-Footman-Installation-Corvette/dp/B0D8BR83D4) (~$10, need 2) + [Cartman 1" x 12 ft cam-buckle lashing straps, 6-pack](https://www.amazon.com/CARTMAN-Lashing-Straps-600lbs-Carry/dp/B017902W8G) (~$14, 600-lb break — need 1; the spares cover the pantry + DELTA 3 drawer straps). Prices approximate — check at order time.
...
**Total: ~$3,370–3,760 with the fridge + kitchen, or ~$2,670–2,910 if you already own equivalents** (see Section 4 for the full itemized BOM and every purchase link).
